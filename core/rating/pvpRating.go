...
/*
	...
	rating.WriteRating(1, 2, false, 999999999, 8, 150, "premierUltra")
	rating.WriteRating(2, 2, false, 999999999, 15, 80, "premierUltra")


	rating.WriteRating(0, 0, false, 999999999, 2, 200, "premier")
	rating.WriteRating(0, 1, false, 999999999, 2, 200, "premier")
	rating.WriteRating(1, 1, false, 999999999, 5, 200, "premier")
	rating.WriteRating(1, 2, false, 999999999, 8, 150, "premier")
	rating.WriteRating(2, 2, false, 999999999, 15, 80, "premier")

	rating.WriteRating(0, 0, false, 999999999, 2, 200, "master")
	rating.WriteRating(0, 1, false, 999999999, 2, 200, "master")
	rating.WriteRating(1, 1, false, 999999999, 5, 200, "master")
	rating.WriteRating(1, 2, false, 999999999, 8, 150, "master")
	rating.WriteRating(2, 2, false, 999999999, 15, 80, "master")

	rating.WriteRating(0, 0, false, 999999999, 2, 200, "ultra")
	rating.WriteRating(0, 1, false, 999999999, 2, 200, "ultra")
	rating.WriteRating(1, 1, false, 999999999, 5, 200, "ultra")
	rating.WriteRating(1, 2, false, 999999999, 8, 150, "ultra")
	rating.WriteRating(2, 2, false, 999999999, 15, 80, "ultra")

	rating.WriteRating(0, 0, false, 999999999, 2, 200, "great")
	rating.WriteRating(0, 1, false, 999999999, 2, 200, "great")
	rating.WriteRating(1, 1, false, 999999999, 5, 200, "great")
	rating.WriteRating(1, 2, false, 999999999, 8, 150, "great")
