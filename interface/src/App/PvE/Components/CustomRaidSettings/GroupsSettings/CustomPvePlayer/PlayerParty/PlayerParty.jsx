...
class PlayerParty extends React.PureComponent {
    render() {
        return (
            <div className="row m-0 align-items-center justify-conten-center text-left">
                <div style={{ textTransform: "capitalize" }} className="fBolder col-12 px-0">{`${this.props.title} ${this.props.partyNumber + 1}`}</div>
