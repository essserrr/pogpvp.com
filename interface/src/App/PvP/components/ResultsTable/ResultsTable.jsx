            ...
            {props.value && <>
                ...
                <tbody className="modifiedBorderTable">
                    <Line
                        ...
                        valueA={<div className={"rate " + ((props.value.Attacker.Rate > 500) ? "win" : "lose")}>{props.value.Attacker.Rate}</div>}
                        valueD={<div className={"rate " + ((props.value.Defender.Rate > 500) ? "win" : "lose")}>{props.value.Defender.Rate}</div>}
                    />
                    <Line
