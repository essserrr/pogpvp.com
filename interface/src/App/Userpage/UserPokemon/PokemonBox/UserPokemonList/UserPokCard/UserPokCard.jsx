...
const UserPokCard = React.memo(function (props) {
    console.log(props.moveTable[props.value.QuickMove])
    console.log(props.moveTable[props.value.ChargeMove])
    return (
        <div className="upokcard col-auto p-1 m-1 text-center">
            <div className="mx-1 mb-1 row align-items-center">
                ...
                <div className="col px-2">{`${props.value.Lvl}/${props.value.Atk}/${props.value.Def}/${props.value.Sta}`}</div>
