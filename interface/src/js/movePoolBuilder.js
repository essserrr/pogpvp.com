export class MovePoolBuilder {
    ...
    filterMoves(isBoss) {
        this.pokemon.QuickMoves = this.pokemon.QuickMoves.filter(elem => (isBoss && !!pokemon.EliteMoves[elem]) ? false : elem !== "");
        this.pokemon.ChargeMoves = this.pokemon.ChargeMoves.filter(elem => (isBoss && (!!pokemon.EliteMoves[elem] || elem === "Return")) ? false : elem !== "");
    }
